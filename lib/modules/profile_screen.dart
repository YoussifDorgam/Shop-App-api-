          ...
          appBar: AppBar(
            ...
            title: Row(
              children: const [
                ...
                Text('Salla',style: TextStyle(color: Colors.black),),
              ],
            ),
          ),
          body: ShopAppcubit.get(context).UserModej == null ? const Center(child: CircularProgressIndicator())
                              ...
                              TextButton(
                                  onPressed: () {
                                    editPressed(
                                        ...
                                        email: cubit.UserModej!.data!.email
                                    );
                                  },
                                  child: Row(
                                    children: [
