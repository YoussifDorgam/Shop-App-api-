...
class CategoryProductsScreen extends StatelessWidget {
      ...
      builder: (context,state){
        return Scaffold(
          appBar: AppBar(
            ...
            title: Row(
              children: const [
                Image(image: AssetImage('assets/images/image4.png'),width: 50, height: 50,),
                Text('Sala' ,
          ...
          const Center(child: CircularProgressIndicator(),) :  ShopAppcubit.get(context).shopHomeModel!.data!.products.isEmpty ?
                ...
                children: [
                  ...
                  GridView.count(
                    ...
                    children: List.generate(
                        ShopAppcubit.get(context).shopHomeModel!.data!.products.length,
                            (index) => ShopAppcubit.get(context).shopHomeModel!.data!.products.isEmpty ?
                        const Center(child: Text('Coming Soon',style: TextStyle(fontSize: 50),),) :
                            bodyItem(ShopAppcubit.get(context).shopHomeModel!.data!.products[index],context)
                    ),
                    crossAxisSpacing: 2,
  ...
  Widget bodyItem(ProductsData model, context) => InkWell(
    onTap: (){
