...
class ContactScreen extends StatelessWidget {
                ...
                Expanded(
                  child: InkWell(
                    ...
                    child: const CircleAvatar(
                      ...
                      backgroundColor: Colors.grey,
                      backgroundImage: NetworkImage(
                        'https://th.bing.com/th/id/OIP.hSNlZWz5XYMWjVCNAzR-jwHaFP?pid=ImgDet&rs=1',
                      ),
                    ),
                  ),
                ),
  ...
  void messenger() async {
    const url =
        "https://l.facebook.com/l.php?u=https%3A%2F%2Fm.me%2Fyoussf.dorgam%3Ffbclid%3DIwAR0DJ4inJM15HhKCBLEaglIZrSGMY5w-6RP-334CoXREbmyYSQ71g7jWx48&h=AT24d8sM0oSOxShMV9xha4CJ74JGOnpuNeGhG5wU-P6JTP_0u3FkKMa2fA1-I1inJUaVau90EAm2d11Sunvh-_wZjfgVHEjHFNuFtKUWdXV21aIHdEEMNFC_Ju_N2jDdfIR68A";
    if (!await launch(url)) throw 'Could not launch $url';
  }
